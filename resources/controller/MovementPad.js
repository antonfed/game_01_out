...
class MovementPad {
    ...
    alignAndConfigPad(canvas) {
        //this.padElement.style.top =  window.innerHeight/2 + 'px';
        //this.padElement.style.left =  window.innerWidth/2
        //this.padElement.style.left =  window.innerWidth/2 + 'px';
        //this.padElement.style.top =  window.innerHeight
